    ...
    <>
      ...
      <div className="bg-[#FF7B00] min-h-screen grid grid-cols-2 font-[Poppins] relative overflow-hidden pt-32">
        ...
        <div className="col1 flex flex-col justify-center items-center p-10 z-10">
          <h1 className="text-5xl font-extrabold uppercase text-white drop-shadow-[0_0_15px_#000] tracking-widest mb-10">
          ...
          <div className="flex flex-col gap-5 w-[350px]">
            ...
            <h2 className="font-semibold text-2xl">Step 3: Add profile picture and finalize!</h2>
            <input
              type="text"
